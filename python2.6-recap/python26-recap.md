...
^ Probably should have browsed the issues to see if it was appropriate
...
![fit](images/pyramid_mailer.png)

^ But some projects were receptive

---

![fit](images/venusian.png)

---

![fit](images/pyramid_rpc.png)
